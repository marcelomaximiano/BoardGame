...
void SaveDataEEPROM() {
   // pergunta 8
   romWrite("0026|03|éã          ");
   romWrite("Quem destruiu o     ");
   romWrite("nariz da Esfinge    ");
   romWrite("de Gizé?            ");
   romWrite("                    ");
   romWrite("Napoleão Bonaparte  ");
   romWrite("Hittler             ");
   romWrite("Cristãos Coptas    *");
   // pergunta 9
   romWrite("0029|03|éç          ");
   romWrite("Em qual época ocorre");
   romWrite("as cheias do rio    ");
   romWrite("Nilo?               ");
   romWrite("                    ");
   romWrite("junho-setembro     *");
   romWrite("outubro-fevereiro   ");
   romWrite("março-maio          ");
   // pergunta 10
   romWrite("0031|03|õúí         ");
   romWrite("Qual era o nome do  ");
   romWrite("deus que guardava   ");
   romWrite("os pulmões?         ");
   romWrite("                    ");
   romWrite("Anúbis              ");
   romWrite("Osíris              ");
   romWrite("Hapy               *");
   // pergunta 11
   romWrite("0032|02|éÍó         ");
   romWrite("Qual é o deus da    ");
   romWrite("Lua?                ");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Konshu             *");
