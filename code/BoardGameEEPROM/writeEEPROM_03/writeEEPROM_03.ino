...
void SaveDataEEPROM() {
   // pergunta 11
   romWrite("0035|02|çãúó        ");
   romWrite("Qual deus tem cabeça");
   romWrite("de falcão?          ");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Anúbis              ");
   ...
   // pergunta 12
   romWrite("0040|04|ã           ");
   romWrite("Quem foi falsamente ");
   romWrite("acusado de quebrar o");
   romWrite("nariz da Esfinge?   ");
   romWrite("                    ");
   romWrite("Napoleão Bonaparte *");
   romWrite("Marco Polo          ");
   romWrite("Caesar              ");
   // pergunta 13
   romWrite("0045|03|ã           ");
   romWrite("Qual animal era     ");
   romWrite("considerado sagrado?");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Gato               *");
   romWrite("Falcão              ");
   ...
   // Perguntas médias
   // pergunta 1
   romWrite("0004|03|êâáúó       ");
   romWrite("Para o quê serviam  ");
   romWrite("as pirâmides?       ");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Moradia p. faraós   ");
   romWrite("Túmulos p. faraós  *");
   romWrite("Cultos religiosos   ");
}
