...
void SaveDataEEPROM() {
   // pergunta 17
   romWrite("0041|03|úóé         ");
   romWrite("Quem foi o último   ");
   romWrite("faraó do Egito      ");
   romWrite("Antigo?             ");
   romWrite("                    ");
   romWrite("Cesarión           *");
   romWrite("Tutankamon          ");
   ...
   // pergunta 18
   romWrite("0042|04|óé          ");
   romWrite("Quem foi o primeiro ");
   romWrite("faraó a ser         ");
   romWrite("enterrado no Vale   ");
   romWrite("dos Deuses?         ");
   romWrite("Amenófis III        ");
   romWrite("Tutmés I           *");
   romWrite("Ramsés II           ");
   // pergunta 19
   romWrite("0046|04|óé          ");
   romWrite("Qual faraó construiu");
   romWrite("o templo de Luxor?  ");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Tutmés IV           ");
   romWrite("Amenófis III       *");
   ...
   // pergunta 1
   romWrite("0003|03|éâ          ");
   romWrite("Qual é a altura da  ");
   romWrite("pirâmide de Quéops? ");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("146 metros         *");
   romWrite("123 metros          ");
