...
void SaveDataEEPROM() {
  // Perguntas fáceis
  // pergunta 1
  romWrite("0001|02|ãÁé         ");
  romWrite("Em qual região fica ");
  romWrite("o Egito?            ");
  romWrite("                    ");
  romWrite("                    ");
  romWrite("Norte da África    *");
  romWrite("Oriente Médio       ");
  romWrite("Sul da Ásia         ");
  // pergunta 2
  romWrite("0002|03|éâó         ");
  romWrite("Qual é a maior das  ");
  ...
  romWrite("0005|02|é           ");
  romWrite("O que é um          ");
  romWrite("escaravelho?        ");
  romWrite("                    ");
  romWrite("                    ");
  romWrite("Uma pedra preciosa  ");
  romWrite("Um inseto          *");
  romWrite("Um tipo de rato     ");
  // pergunta 4
  romWrite("0010|02|óá          ");
  romWrite("Os Faraós eram :    ");
  romWrite("                    ");
  romWrite("                    ");
  romWrite("                    ");
  romWrite("Amáveis             ");
  ...
  // pergunta 5
  romWrite("0014|03|í           ");
  romWrite("Quando um egípcio   ");
  romWrite("morria ele era:     ");
  romWrite("                    ");
  romWrite("                    ");
  romWrite("Cremado             ");
  romWrite("Mumificado         *");
  romWrite("Jogado no Rio Nilo  ");
}
