...
void SaveDataEEPROM() {
   // pergunta 3
   romWrite("0009|02|óçã         ");
   romWrite("O que significa o   ");
   romWrite("Olho de Hórus?      ");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Guerra e sangue     ");
   romWrite("Paz e amor          ");
   romWrite("Poder e Proteção   *");
   // pergunta 4
   romWrite("0011|03|é           ");
   romWrite("O que tinha no      ");
   romWrite("chapéu do rei do    ");
   romWrite("Norte do Egito?     ");
   romWrite("                    ");
   romWrite("Um Abutre          *");
   romWrite("Uma cobra           ");
   romWrite("Um elefante         ");
   // pergunta 5
   romWrite("0012|03|            ");
   romWrite("Qual o nome do pai  ");
   romWrite("de Tutankamon?      ");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Tutankamon          ");
   romWrite("Ankehenaton        *");
   romWrite("Oitik               ");
   // pergunta 6
   romWrite("0018|02|ó           ");
   romWrite("Quem decifrou os    ");
   romWrite("hieróglifos?        ");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Pedro de Miercie    ");
   romWrite("Leonardo da Vinci   ");
   romWrite("Jean F Champollion *");
   // pergunta 7
   romWrite("0020|02|éã          ");
   romWrite("O deus Sobek é      ");
   romWrite("representado por um:");
   romWrite("                    ");
   romWrite("                    ");
   romWrite("Leão                ");
   romWrite("Crocodilo          *");
